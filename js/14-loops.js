...
for (; i < marksFor2.length; i++) { // iskelem let 1 = 0 pries cikla, butinai paliekam ; (pradzioj po skliaustelio)
...
for (let i = 0, j = marksFor3.length; i < marksFor3.  // galima irasyt daugiau parametru, po kablelio, pvz: let i = 0, j = marksFor3.length;
length && j >= 3 ; i++, j--) {
